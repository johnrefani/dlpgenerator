  ...
  return (
    <div className="w-full overflow-x-hidden relative">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 bg-blue-600 text-white rounded-full p-4 shadow-lg hover:bg-blue-700 focus:outline-none transition-colors duration-200 z-50"
